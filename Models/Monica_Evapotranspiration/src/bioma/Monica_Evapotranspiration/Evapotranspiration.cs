...
{
    public class Evapotranspiration : IStrategyEvapotranspirationComp
    {
        public Evapotranspiration()
        {
            ...
            pd13.PropertyType = (EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.snow_depth).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.snow_depth);
            _inputs0_0.Add(pd13);
            ...
            pd14.PropertyType = (EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.developmental_stage).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.developmental_stage);
            _inputs0_0.Add(pd14);
            ...
            pd15.PropertyType = (EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.crop_reference_evapotranspiration).ValueType.TypeForCurrentValue;
            pd15.PropertyVarInfo =(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.crop_reference_evapotranspiration);
            _inputs0_0.Add(pd15);
            ...
            pd16.PropertyType = (EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.reference_evapotranspiration).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.reference_evapotranspiration);
            _inputs0_0.Add(pd16);
            ...
            pd17.PropertyType = (EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.actual_evaporation).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.actual_evaporation);
            _inputs0_0.Add(pd17);
            ...
            pd18.PropertyType = (EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.actual_transpiration).ValueType.TypeForCurrentValue;
            pd18.PropertyVarInfo =(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.actual_transpiration);
            _inputs0_0.Add(pd18);
            ...
            pd19.PropertyType = (EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.surface_water_storage).ValueType.TypeForCurrentValue;
            pd19.PropertyVarInfo =(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.surface_water_storage);
            _inputs0_0.Add(pd19);
        ...
        public string TestPostConditions(EvapotranspirationComp.DomainClass.EvapotranspirationCompState s,EvapotranspirationComp.DomainClass.EvapotranspirationCompState s1,EvapotranspirationComp.DomainClass.EvapotranspirationCompRate r,EvapotranspirationComp.DomainClass.EvapotranspirationCompAuxiliary a,EvapotranspirationComp.DomainClass.EvapotranspirationCompExogenous ex,string callID)
        {
            ...
            {
                string msg = ".EvapotranspirationComp, " + this.GetType().Name + ": Unhandled exception running post-condition test. ";
        ...
        public string TestPreConditions(EvapotranspirationComp.DomainClass.EvapotranspirationCompState s,EvapotranspirationComp.DomainClass.EvapotranspirationCompState s1,EvapotranspirationComp.DomainClass.EvapotranspirationCompRate r,EvapotranspirationComp.DomainClass.EvapotranspirationCompAuxiliary a,EvapotranspirationComp.DomainClass.EvapotranspirationCompExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r13 = new RangeBasedCondition(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.snow_depth);
                if(r13.ApplicableVarInfoValueTypes.Contains( EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.snow_depth.ValueType)){prc.AddCondition(r13);}
                RangeBasedCondition r14 = new RangeBasedCondition(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.developmental_stage);
                if(r14.ApplicableVarInfoValueTypes.Contains( EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.developmental_stage.ValueType)){prc.AddCondition(r14);}
                RangeBasedCondition r15 = new RangeBasedCondition(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.crop_reference_evapotranspiration);
                if(r15.ApplicableVarInfoValueTypes.Contains( EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.crop_reference_evapotranspiration.ValueType)){prc.AddCondition(r15);}
                RangeBasedCondition r16 = new RangeBasedCondition(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.reference_evapotranspiration);
                if(r16.ApplicableVarInfoValueTypes.Contains( EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.reference_evapotranspiration.ValueType)){prc.AddCondition(r16);}
                RangeBasedCondition r17 = new RangeBasedCondition(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.actual_evaporation);
                if(r17.ApplicableVarInfoValueTypes.Contains( EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.actual_evaporation.ValueType)){prc.AddCondition(r17);}
                RangeBasedCondition r18 = new RangeBasedCondition(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.actual_transpiration);
                if(r18.ApplicableVarInfoValueTypes.Contains( EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.actual_transpiration.ValueType)){prc.AddCondition(r18);}
                RangeBasedCondition r19 = new RangeBasedCondition(EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.surface_water_storage);
                if(r19.ApplicableVarInfoValueTypes.Contains( EvapotranspirationComp.DomainClass.EvapotranspirationCompStateVarInfo.surface_water_storage.ValueType)){prc.AddCondition(r19);}
            ...
            {
                string msg = ".EvapotranspirationComp, " + this.GetType().Name + ": Unhandled exception running pre-condition test. ";
                throw new Exception(msg, exception);
            }
        }
