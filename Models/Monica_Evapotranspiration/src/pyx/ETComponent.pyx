...
from Monica_Evapotranspiration.referenceevapotranspiration import model_referenceevapotranspiration, init_referenceevapotranspiration
from Monica_Evapotranspiration.potentialevapotranspiration import model_potentialevapotranspiration, init_potentialevapotranspiration
def model_et(float reference_albedo,
    ...
    reference_evapotranspiration, net_radiation = model_referenceevapotranspiration(reference_albedo,stomata_resistance,latitude,height_nn,max_air_temperature,min_air_temperature,mean_air_temperature,relative_humidity,wind_speed,wind_speed_height,global_radiation,julian_day,vapor_pressure,net_radiation,reference_evapotranspiration)
    potential_evapotranspiration, reference_evapotranspiration = model_potentialevapotranspiration(reference_evapotranspiration,external_reference_evapotranspiration,kc_factor,developmental_stage,crop_reference_evapotranspiration,crop_remaining_evapotranspiration,potential_evapotranspiration)
...
def init_et(float evaporation_zeta,
    ...
    net_radiation, reference_evapotranspiration = init_referenceevapotranspiration(reference_albedo, stomata_resistance, latitude, height_nn, max_air_temperature, min_air_temperature, mean_air_temperature, relative_humidity, wind_speed, wind_speed_height, global_radiation, julian_day, vapor_pressure)
    potential_evapotranspiration = init_potentialevapotranspiration(reference_evapotranspiration, external_reference_evapotranspiration, kc_factor, developmental_stage, crop_reference_evapotranspiration, crop_remaining_evapotranspiration)
